...
import com.yankin.settings.impl.presentation.exercise_pattern_list.ExercisePatternListFragment
    ...
    override fun addNode(navGraphBuilder: NavGraphBuilder) {
        navGraphBuilder.apply {
            navigation(startDestination = SETTINGS_FRAGMENT_DESTINATION, route = ROUTE) {
                ...
                fragment<ExercisePatternListFragment>(EXERCISE_AUTOFILL_FRAGMENT_DESTINATION)
            }
        }
    }
