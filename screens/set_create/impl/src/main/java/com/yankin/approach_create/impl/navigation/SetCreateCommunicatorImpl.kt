...
import com.yankin.approach_create.api.navigation.EmptyArgumentException
...
class SetCreateCommunicatorImpl @Inject constructor(
    ...
    private fun SetCreateParams.toParcelable(): SetCreateParcelableParams {
        return superSetId?.let { saveSuperSetId ->
            SetCreateParcelableParams.SuperSetCreate(saveSuperSetId)
        } ?: exerciseId?.let { exerciseId ->
            SetCreateParcelableParams.SetCreate(exerciseId)
