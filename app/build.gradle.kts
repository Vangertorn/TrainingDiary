...
dependencies {
    ...
    implementation(project(":features:training_block:impl"))
    ...
    implementation(project(":screens:workout_routines:impl"))
    ...
    implementation(project(":workers:clear_delete_queue:impl"))
